  ...
  return (
    <footer className="bg-primary text-primary-foreground py-10 md:py-16">
      <div className="container mx-auto px-4">
        ...
        {/* Redes Sociales */}
        <div className="border-t border-primary-foreground/20 py-6 md:pt-8">
          <div className="flex flex-col items-center gap-4">
            <h4 className="font-semibold text-base md:text-lg">Síguenos en Redes Sociales</h4>
            <div className="flex gap-4">
              ...
              <a
                ...
                className="w-10 h-10 md:w-12 md:h-12 bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full flex items-center justify-center transition-all hover:scale-110 cursor-pointer"
                aria-label="Facebook"
              >
